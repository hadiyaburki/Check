...
function draw() {
 background(0);
  ...
  if (blueballoonGroup.isTouching(arrowGroup)|| greenballoonGroup.isTouching(arrowGroup) || redballoonGroup.isTouching(arrowGroup) || pinkballoonGroup.isTouching(arrowGroup)){
    score += 1
